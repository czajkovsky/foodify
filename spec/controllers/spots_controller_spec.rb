...
describe SpotsController do
  ...
  let(:valid_attributes) { { "balance" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved spot as @spot" do
        ...
        post :create, {:spot => { "balance" => "invalid value" }}, valid_session
        assigns(:spot).should be_a_new(Spot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested spot" do
        ...
        Spot.any_instance.should_receive(:update_attributes).with({ "balance" => "1" })
        put :update, {:id => spot.to_param, :spot => { "balance" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the spot as @spot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Spot.any_instance.stub(:save).and_return(false)
        put :update, {:id => spot.to_param, :spot => { "balance" => "invalid value" }}, valid_session
        assigns(:spot).should eq(spot)
      end
